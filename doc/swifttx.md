...
This mechanism has been integrated into Bitcore-Node-PandaCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PandaCash-Project/insight-api-pandacash#web-socket-api](https://github.com/PandaCash-Project/insight-api-pandacash#web-socket-api) 
* API: [https://github.com/PandaCash-Project/insight-api-pandacash#swifttx-transactions](https://github.com/PandaCash-Project/insight-api-pandacash#swifttx-transactions) 
...
By default, the PandaCash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PandaCash Core daemon:
