...
In order to support loading of multiple wallets in pandacash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pandacash.cpp.
...
Changes to pandacash.cpp
----------------------
pandacash.cpp is the entry point into pandacash-qt, and as such, will require some minor modifications to provide hooks for
