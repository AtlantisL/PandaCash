Contributing to PandaCash Core
============================

The PandaCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PandaCash Core project, and is not to be
confused with overall PandaCash Network Protocol consensus changes.

Whether a pull request is merged into PandaCash Core rests with the project merge
...
Patches that change PandaCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the PandaCash consensus, it must have been
...
The project leader is the release manager for each PandaCash Core release.
