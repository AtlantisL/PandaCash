...
{
public:
    /// Is the inputs associated with this public key? (and there is 200000 PANDA - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of pandacash.
