...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PandaCash Core pandacash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pandacash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pandacash transaction") + "\n" +
                               "  pandacash-tx [options] -create [commands]   " + _("Create hex-encoded pandacash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pandacash transaction
