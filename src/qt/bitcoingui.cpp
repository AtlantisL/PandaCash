                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PandaCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PandaCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pandacash: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPANDA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PandaCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about PandaCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PandaCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PandaCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PandaCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a PandaCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PandaCash Core help message to get a list with possible PandaCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PandaCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PandaCash network", "", count));
}
...
{
    QString strTitle = tr("PandaCash Core"); // default title
