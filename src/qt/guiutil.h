...
/** Utility functions used by the PandaCash Qt UI.
 */
namespace GUIUtil
{
...
// Render PandaCash addresses in monospace font
...
// Parse "pandacash:" URI into recipient object, return true on successful parsing
