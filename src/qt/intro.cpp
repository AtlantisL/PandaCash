...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PandaCash Core"),
     ...
     * override -datadir in the pandacash.conf file in the default data directory
     * (to be consistent with pandacashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
