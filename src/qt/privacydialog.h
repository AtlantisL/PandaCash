...
public:
    ...
    void setZPANDAControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzPANDA_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzPANDA_clicked();
    void on_pushButtonZPANDAControl_clicked();
