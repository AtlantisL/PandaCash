...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop PandaCash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "PandaCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PandaCash features */
        {"pandacash", "masternode", &masternode, true, true, false},
        {"pandacash", "listmasternodes", &listmasternodes, true, true, false},
        {"pandacash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pandacash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pandacash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pandacash", "masternodedebug", &masternodedebug, true, true, false},
        {"pandacash", "startmasternode", &startmasternode, true, true, false},
        {"pandacash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pandacash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pandacash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pandacash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pandacash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pandacash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pandacash", "mnbudget", &mnbudget, true, true, false},
        {"pandacash", "preparebudget", &preparebudget, true, true, false},
        {"pandacash", "submitbudget", &submitbudget, true, true, false},
        {"pandacash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pandacash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pandacash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pandacash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pandacash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pandacash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pandacash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pandacash", "checkbudgets", &checkbudgets, true, true, false},
        {"pandacash", "mnsync", &mnsync, true, true, false},
        {"pandacash", "spork", &spork, true, true, false},
        {"pandacash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"pandacash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use pandacashd, or the -server option to pandacash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> pandacash-cli " + methodname + " " + args + "\n";
}
